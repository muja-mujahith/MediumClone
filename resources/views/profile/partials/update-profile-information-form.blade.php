<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6"  enctype="multipart/form-data">
        ...
        @if($user->image)
            <div>
                <img src="{{ Storage::url($user->image) }}" alt="" class="rounded-full h-20 w-20">
            </div>
        @endif
        ...
        <div class="mt-4">
            ...
            <x-input-textarea id="bio" class="block mt-1 w-full" type="text" name="bio" :value="old('bio', $user->bio)" required autofocus>{{ $user->bio }}</x-input-textarea>
